...
import 'package:showbox/view/components/rounded_button.dart';
...
class _NavigationDrawerWidgetState extends State<NavigationDrawerWidget> {
  ...
  void showErrorSnackbar() {
    CustomSnackbar.showCustomSnackbar(
        errorList: ['Guest user are not eligible to access this section,Pls login first'], msg: [], isError: true);
  }
