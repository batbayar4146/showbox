...
import 'package:showbox/data/controller/live_tv_details_controller/live_tv_details_controller.dart';
import 'package:showbox/data/repo/live_tv_repo/live_tv_repo.dart';
import 'package:showbox/data/services/api_service.dart';
import 'package:showbox/view/components/header_light_text.dart';
import 'package:showbox/view/components/text/header_view_text.dart';
import 'package:showbox/view/screens/live_tv_details/widget/live_tv_details_shimmer_widget/live_tv_details_shimmer_widget.dart';
import 'package:showbox/view/screens/live_tv_details/widget/related_item_list.dart';
                              ...
                              Column(
                                ...
                                children: [
                                  const Padding(
                                      ...
                                      child: HeaderLightText(text: MyStrings.channelDescription)),
                                  const CustomSizedBox(),
                                  Padding(
                                      padding: const EdgeInsets.only(left: 10),
                                      child: SmallText(
                                          text: controller.tvObject.description ?? MyStrings.ipsumMovieDetails)),
                                  const SizedBox(
                                    height: 15,
                                  ),
                                ],
