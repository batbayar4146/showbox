...
import 'package:showbox/view/screens/bottom_nav_pages/home/shimmer/live_tv_shimmer.dart';
            ...
            : SingleChildScrollView(
                ...
                child: Row(
                  children: List.generate(
                      controller.relatedTvList.length,
                      (index) => LiveTvGridItem(
                          liveTvName: controller.relatedTvList[index].title ?? '',
                          imageUrl:
                              '${UrlContainer.baseUrl}${controller.imagePath}/${controller.relatedTvList[index].image}',
                          press: () {
                            controller.clearAllData();
                            Get.offAndToNamed(RouteHelper.liveTvDetailsScreen,
                                arguments: controller.relatedTvList[index].id);
                          })),
                ),
              ));
  }
