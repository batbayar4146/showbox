...
class EmailVerificationScreen extends StatefulWidget {
  const EmailVerificationScreen({Key? key, required this.needSmsVerification}) : super(key: key);
...
class _EmailVerificationScreenState extends State<EmailVerificationScreen> {
  ...
  Widget build(BuildContext context) {
    Get.find<EmailVerificationController>().needSmsVerification = widget.needSmsVerification;
                                ...
                                TextButton(
                                    ...
                                    child: Text(MyStrings.resend,
                                        style: mulishBold.copyWith(
                                            decoration: TextDecoration.underline, color: MyColor.colorWhite)))
                              ],
                            ),
                            const SizedBox(
                              height: 14,
