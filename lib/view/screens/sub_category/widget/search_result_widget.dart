...
import 'package:showbox/core/helper/string_format_helper.dart';
import 'package:showbox/core/utils/my_color.dart';
import 'package:showbox/core/utils/styles.dart';
import 'package:showbox/data/controller/my_search_controller/search_controller.dart';
import 'package:showbox/data/repo/my_search/my_search_repo.dart';
import 'package:showbox/view/screens/bottom_nav_pages/home/shimmer/grid_shimmer.dart';
import 'package:showbox/view/screens/bottom_nav_pages/home/widget/custom_network_image/custom_network_image.dart';
import 'package:showbox/view/screens/movie_details/widget/rating_and_watch_widget/RatingAndWatchWidget.dart';
...
class SearchResultListWidget extends StatefulWidget {
  ...
  const SearchResultListWidget({Key? key, this.searchText = '', this.categoryId = -1, this.subCategoryId = -1})
      : super(key: key);
          ...
          : Flexible(
              child: GridView.builder(
                  ...
                  gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                      crossAxisSpacing: 15, mainAxisSpacing: 12, crossAxisCount: 3, childAspectRatio: .55),
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: <Widget>[
                        ...
                        SingleChildScrollView(
                            ...
                            child: RatingAndWatchWidget(
                                rating: CustomValueConverter.twoDecimalPlaceFixedWithoutRounding(
                                    controller.movieList[index].ratings ?? '0'),
                                watch: CustomValueConverter.twoDecimalPlaceFixedWithoutRounding(
