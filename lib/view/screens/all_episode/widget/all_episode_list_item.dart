...
import 'package:showbox/data/controller/all_episode_controller/all_episode_controller.dart';
import 'package:showbox/data/repo/all_episode_repo/all_episode_repo.dart';
...
class _AllEpisodeListWidgetState extends State<AllEpisodeListWidget> {
  ...
  void initState() {
    ...
    AllEpisodeController controller = Get.put(AllEpisodeController(repo: Get.find()));
    super.initState();
                          ...
                          child: GestureDetector(
                            onTap: () {
                              Get.toNamed(RouteHelper.movieDetailsScreen,
                                  arguments: [controller.episodeList[index].id, -1]);
                            },
                            child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: <Widget>[
                              ...
                              Container(
                                ...
                                color: MyColor.colorBlack,
                                child: Text(controller.episodeList[index].title ?? '',
