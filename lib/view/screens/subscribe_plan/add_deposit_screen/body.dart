                                ...
                                children: [
                                  TextSpan(
                                    ...
                                    style: mulishSemiBold.copyWith(
                                        color: MyColor.primaryColor, fontSize: Dimensions.fontOverLarge),
                                  ),
                                  TextSpan(
                                    text: MyStrings.nowYouHave,
                                    style: mulishRegular.copyWith(
                                        color: Colors.white, fontSize: Dimensions.fontExtraLarge),
                                  ),
                                  TextSpan(
