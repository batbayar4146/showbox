...
import 'package:showbox/data/controller/live_tv_controller/live_tv_controller.dart';
...
import 'package:showbox/view/screens/all_live_tv/widget/all_live_tv_shimmer/all_live_tv_shimmer.dart';
import 'package:showbox/view/screens/all_live_tv/widget/live_tv_grid_item/live_tv_grid_item.dart';
                ...
                child: Column(
                  children: [
                    controller.isLoading
                        ? const Flexible(child: AllLiveTvShimmer())
                        : Expanded(
                            child: GridView.builder(
                                itemCount: controller.televisionList.length,
                                gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                                    mainAxisSpacing: 10, crossAxisCount: 4, childAspectRatio: 1),
                                itemBuilder: (context, index) => LiveTvGridItem(
                                    ...
                                    press: () {
                                      Get.toNamed(RouteHelper.liveTvDetailsScreen,
                                          arguments: controller.televisionList[index].id);
                                    })))
                  ],
                ),
              ),
