                      ...
                      return SizedBox(
                        ...
                        onTap: () {
                          Get.toNamed(RouteHelper.movieDetailsScreen,
                              arguments: [controller.featuredMovieList[index].id, -1]);
                        },
                        child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: <Widget>[
                          ...
                          Container(
                            padding: const EdgeInsets.only(left: 0, top: 8.0, bottom: 8.0, right: 0),
                            decoration: const BoxDecoration(
                              color: Colors.transparent,
                              borderRadius:
                                  BorderRadius.only(bottomRight: Radius.circular(8), bottomLeft: Radius.circular(8)),
                            ),
                            child: Text('${controller.featuredMovieList[index].title}',
