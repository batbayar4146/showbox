                              ...
                              (index) => GestureDetector(
                                    onTap: () {
                                      Get.toNamed(RouteHelper.movieDetailsScreen,
                                          arguments: [controller.trailerMovieList[index].id, -1]);
                                    },
                                    child: Container(
                                      width: 115,
                                        ...
                                        children: [
                                          ClipRRect(
                                            ...
                                            child: CustomNetworkImage(
                                              imageUrl:
                                                  '${UrlContainer.baseUrl}${controller.trailerImagePath}/${controller.trailerMovieList[index].image?.portrait}',
                                              width: 105,
                                              height: 160,
                                              boxFit: BoxFit.cover,
                                            ),
                                          ...
                                          Text(
                                            '${controller.trailerMovieList[index].title}',
