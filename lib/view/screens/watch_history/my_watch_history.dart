...
import 'package:showbox/constants/my_strings.dart';
import 'package:showbox/core/utils/my_color.dart';
import 'package:showbox/data/controller/my_watch_history_controller/my_watch_history_controller.dart';
    ...
    return GetBuilder<MyWatchHistoryController>(
        builder: (controller) => Scaffold(
              ...
              appBar: const CustomAppBar(
                title: MyStrings.myHistory,
                bgColor: Colors.transparent,
              ),
              body: !controller.isLoading && controller.movieList.isEmpty
                                                      ...
                                                      children: [
                                                        ...
                                                        HeaderLightText(
                                                            text: controller.movieList[index].item != null
                                                                ? controller.movieList[index].item?.title ?? ''
                                                                : controller.movieList[index].episode?.title ?? ''),
                                                        const SizedBox(
                                                          height: 10,
                                                        ),
                                                        Row(
                                                          ...
                                                          children: [
                                                            RatingAndWatchWidget(
                                                                ...
                                                                rating:
                                                                    controller.movieList[index].item?.ratings ?? '0.0')
                                                          ],
                                                        )
                                                      ],
                                                    ),
