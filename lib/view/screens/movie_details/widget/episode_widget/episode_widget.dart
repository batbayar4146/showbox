...
import 'package:showbox/view/screens/movie_details/widget/episode_widget/episode_shimmer_effect.dart';
...
class _EpisodeWidgetState extends State<EpisodeWidget> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<MovieDetailsController>(builder: (controller) {
      int episodeLength =
          controller.movieDetails.data?.episodes != null ? controller.movieDetails.data!.episodes!.length : 0;
                          ...
                          itemBuilder: (context, index) => InkWell(
                                ...
                                onTap: () {
                                  ...
                                  Get.offAndToNamed(RouteHelper.movieDetailsScreen,
                                      arguments: [itemId, controller.episodeList[index].id ?? -1]);
                                },
                                child: Container(
                                  margin: const EdgeInsets.only(right: 10, bottom: 15),
                                  decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(8),
                                    color: controller.episodeId == controller.episodeList[index].id
                                        ...
                                        children: [
                                          ClipRRect(
                                            ...
                                            child: CustomNetworkImage(
                                                ...
                                                height: 120,
                                                imageUrl:
                                                    '${UrlContainer.baseUrl}${controller.episodePath}${controller.episodeList[index].image ?? ''}'),
                                          ),
                                          Positioned(
                                              top: 8,
                                              right: 8,
                                              child: controller.episodeList[index].version == '0'
                                                  ? CategoryButton(
                                                      text: MyStrings.free,
                                                      horizontalPadding: 8,
                                                      verticalPadding: 2,
