...
import 'package:showbox/data/model/home/enum/enum.dart';
import 'package:showbox/data/model/home/featured_movie/FeaturedMovieResponseModel.dart';
import 'package:showbox/data/model/home/latest_series/LateastSeriesResponseModel.dart';
import 'package:showbox/data/model/home/recently_added/RecentlyAddedResponseModel.dart';
import 'package:showbox/data/model/home/single_banner/SingleBannerResponseModel.dart';
import 'package:showbox/data/model/home/slider/SliderModel.dart';
import 'package:showbox/data/model/home/trailer_movie/TrailerMovieResponseModel.dart';
import 'package:showbox/data/model/live_tv/LiveTvResponseModel.dart';
...
class HomeController extends GetxController {
  ...
  void getFeaturedMovie() async {
    ...
    if (model.statusCode == 200) {
      FeaturedMovieResponseModel featuredMovieModel =
          FeaturedMovieResponseModel.fromJson(jsonDecode(model.responseJson));
      if (featuredMovieModel.data != null &&
          featuredMovieModel.data?.featured != null &&
          featuredMovieModel.data!.featured!.isNotEmpty) {
  ...
  void getFreeZoneMovie() async {
    ...
    if (model.statusCode == 200) {
      free_zone.FreeZoneResponseModel freeZoneModel =
          free_zone.FreeZoneResponseModel.fromJson(jsonDecode(model.responseJson));
      if (freeZoneModel.data != null &&
          freeZoneModel.data?.freeZone?.data != null &&
          freeZoneModel.data!.freeZone!.data!.isNotEmpty) {
        freeZoneList.clear();
