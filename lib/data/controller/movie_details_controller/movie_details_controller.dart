...
import 'package:showbox/data/model/play_video_response_model/PlayVideoResponseModel.dart';
import 'package:showbox/data/model/video_details/video_details_response_model/VideoDetailsResponseModel.dart';
import 'package:showbox/data/model/wishlist_model/AddInWishlistResponseModel.dart';
...
class MovieDetailsController extends GetxController {
  ...
  Future<bool> shareVideo(BuildContext context) async {
    ...
    await Share.share("https://play.google.com/store/apps/details?id=${packageInfo.packageName}",
        subject: 'Exclusive movie in Play lab');
    return true;
  }
  ...
  void addInWishList() async {
    ...
    if (model.statusCode == 200) {
      ...
      if (m.status == 'success') {
        ...
        CustomSnackbar.showCustomSnackbar(
            errorList: [m.message?.error ?? 'Fail to Add in Wishlist'], msg: [], isError: true);
      }
